...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/ramdisk/init.viva.rc:root/init.viva.rc \
    $(LOCAL_PATH)/ramdisk/init.viva.usb.rc:root/init.viva.usb.rc \
    $(LOCAL_PATH)/ramdisk/ueventd.viva.rc:root/ueventd.viva.rc
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/huawei/audio/cm_viva_audio_config.conf:system/etc/huawei/audio/cm_viva_audio_config.conf \
    $(LOCAL_PATH)/audio/huawei/audio/cm_viva_audio_config.conf:system/etc/huawei/audio/pac_viva_audio_config.conf \
    $(LOCAL_PATH)/audio/huawei/audio/viva_audio_config.conf:system/etc/huawei/audio/viva_audio_config.conf \
    $(LOCAL_PATH)/audio/huawei/audio/viva_factory_audio_config.conf:system/etc/huawei/audio/viva_factory_audio_config.conf
